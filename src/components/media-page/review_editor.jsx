...
import { useCreateReview } from '@/lib/client/hooks/react_query/review/media/use-create-review';
import { useUpdateReview } from '@/lib/client/hooks/react_query/review/media/use-update-review';
    ...
    >
            ...
            <Controller
              ...
              render={({ field }) => (
                <Toggle
                  ...
                  aria-label={`Favourite ${watchForm('subject')}`}
                />
              )}
            />
          </Flex>
      ...
      <DrawerFooter>
        ...
        <Button
          type="submit"
          colorScheme="primary"
          disabled={saveReview.isPending || updateReview.isPending || !isDirty}
        >
